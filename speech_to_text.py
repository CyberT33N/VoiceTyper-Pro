...
def create_service(service_type, api_key, post_processing=False, llm_optimized=False):
    ...
    if service_type == "deepgram":
        ...
        return OpenAIService.initialize(api_key, post_processing, llm_optimized)
    else:
